# 🏡 GuestVilla Monthly Consumption Report
...
**[Access GuestVilla Monthly Consumption Report](https://1drv.ms/x/c/3b61701caabf1310/IQB6RnvB9zU0RKvis44WRWp6ASRAtLS18_jdastePzhXBpM)**

> **Password: `123`**
> **⚠️ IMPORTANT: Enable Macros for VBA functionality**
> Click "Enable Macros" to activate "Clean Sheet & Next Month" button
...
<img width="1259" height="693" alt="1" src="https://github.com/user-attachments/assets/de67ffe0-0ce0-4794-91e9-f2beb26ed093" />
...
### Grocery Purchase Order Tracking
<img width="1281" height="733" alt="2" src="https://github.com/user-attachments/assets/ab2b16cd-6aa5-460a-9dc3-fcb35c3f5b08" />
...
### Bottle & Alcoholic Beverages Consumption
<img width="1258" height="709" alt="3" src="https://github.com/user-attachments/assets/a595932e-4b61-41c3-9533-5dcfea6c6ffb" />
...
### 5. VBA Macro - Clean Sheet & Next Month
...
3. **Allow Macros** when prompted:
   - Click "Enable Macros" or "Enable Content"
   - VBA functions are required for cleanup button
4. Ready to use!

**Step 2: Enter Monthly Data**
1. Go to **"Grocery Purchase"** sheet
2. Enter daily grocery purchases:
   - Invoice number
   - Purchase date (DD-MM-YYYY)
   - Shop name
   - Item particulars
   - Units & rate
3. Same for **"Bottle Consu."** and **"Hukka Consu."** sheets

**Step 3: View Summary**
1. Go to **"Summary"** sheet
2. See all calculations automatically
3. View monthly usage chart
4. Print or export for reports

**Step 4: End of Month Cleanup**
1. Click **"Clean the Sheet & Nxt Month"** button
...
### Add New Consumption Type:
1. Duplicate any consumption sheet
2. Rename for new category
3. Update Summary to reference new sheet
4. All calculations work automatically

### Add New Item:
1. Go to relevant sheet
2. Enter new row with:
   - Item name
   - Shop/vendor
   - Units
   - Rate
3. Summary includes it automatically
...
### Multiple Villas:
1. Copy entire file
2. Rename for new villa
3. Start tracking separately
4. Or aggregate in master file
...
### How to Use Macro Button:
**Q: "Clean Sheet & Nxt Month" not working?**
A: 
...
**Q: How to enter purchase details?**
A: Go to Grocery/Bottle/Hookah sheet → Fill yellow cells only → All calculations automatic

**Q: How to track daily consumption?**
A: Enter items purchased with invoice details → Daily totals calculate automatically → Summary updates instantly

**Q: Can I add more items?**
A: Yes, each sheet has 155+ rows → Add new rows as needed → All calculations extend automatically
...
![Hospitality](https://img.shields.io/badge/Hospitality-Management-orange)
